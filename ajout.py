...
import os
from req_sql import Inserer_pers
import shutil
...
class Ajout(QWidget):
    def __init__(self):
        ...
        self.btn_enregistrer.setGeometry(200,620,200,40)
    ...
    def enregistrer(self):
        ...
        Inserer_pers(nom,pseudo,age,contact,email,date,mdp1,sexe,image,nat,mdp2)

...
import os
from req_sql import affficher_pers,suppression,modifier
...
class Affichage(QWidget):
    def __init__(self):
        ...
        self.fenetre_popup.setGeometry(500,250,200,150)
        self.fenetre_popup.setStyleSheet("background-color:gray;border-radius:15px")
        
        self.label_image = QLabel(self.fenetre_popup)
        self.label_image.setGeometry(0,0,180,140)
    ...
    def affiche_image(self,item):
        ...
        if col == 9:
            ...
            self.label_image.setPixmap(self.images.scaled(180,140))
    ...
    def action_modif(self,row):
        ...
        print(self.id,nom,pseudo,age,contact,email,date,sexe,nation,matr)
        try:
           modifier(self.id,nom,pseudo,age,contact,email,date,sexe,nation,matr)
           QMessageBox.information(self,"Succès","Personnel Modifier avec succès")
